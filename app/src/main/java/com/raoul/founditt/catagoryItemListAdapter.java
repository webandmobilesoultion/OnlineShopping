 ...
 * @author marvinlabs
 */
public class catagoryItemListAdapter extends ArrayAdapter<catagorysearchitem> {
     ...
     */
    public catagoryItemListAdapter(Context context, List<catagorysearchitem> items) {
